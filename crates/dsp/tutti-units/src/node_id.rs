...
const _: () = tutti_core::node_id::assert_unique(&[
    AUTOMATION_LANE_ID, SVF_FILTER_ID, LADDER_FILTER_ID, EQ_BAND_ID, DELAY_LINE_ID,
    STEREO_DELAY_LINE_ID, LFO_ID, PHASER_ID, CHORUS_ID, FLANGER_ID, DISTORTION_ID,
    CONVOLVER_ID, STEREO_CONVOLVER_ID, GATE_ID, COMPRESSOR_ID, STEREO_GATE_ID,
    STEREO_COMPRESSOR_ID, LIMITER_ID, BRICKWALL_LIMITER_ID, SPATIAL_PANNER_BASE_ID,
    BINAURAL_PANNER_ID,
]);
