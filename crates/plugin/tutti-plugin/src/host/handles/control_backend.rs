//! Backend trait abstracting how a [`PluginHandle`](crate::host::handles::PluginHandle)
...
//! - `InProcessVst2Backend` (in `format::vst2_in_process::control_backend`) —
...
/// can build a [`PluginHandle`](crate::host::handles::PluginHandle) over their
/// own backend via [`PluginHandle::from_backend`](crate::host::handles::PluginHandle::from_backend).
