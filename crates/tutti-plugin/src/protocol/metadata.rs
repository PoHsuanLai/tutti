...
//! [`PluginClass`]) lives in `crate::host::discovery::record`; the runtime
...
pub use crate::host::discovery::record::{AuComponentType, PluginClass, PluginDescriptor, Vst2Category};
