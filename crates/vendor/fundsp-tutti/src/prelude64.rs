...
/// - Input 0: audio
/// - Output 0: filtered audio
pub fn lr_lowpass_hz(f: f64) -> An<LinkwitzRileyLowpass<f64>> {
...
/// - Input 0: audio
/// - Output 0: filtered audio
pub fn lr_highpass_hz(f: f64) -> An<LinkwitzRileyHighpass<f64>> {
...
pub fn lr_crossover_hz(f: f64) -> An<LinkwitzRileyCrossover<f64>> {
...
/// - Input 0: audio
/// - Output 0: filtered audio
pub fn lr_lowpass(order: LrOrder, f: f64) -> An<LinkwitzRileyLowpass<f64>> {
...
/// - Input 0: audio
/// - Output 0: filtered audio
pub fn lr_highpass(order: LrOrder, f: f64) -> An<LinkwitzRileyHighpass<f64>> {
...
/// - Output 0: low frequency band
/// - Output 1: high frequency band
pub fn lr_crossover(order: LrOrder, f: f64) -> An<LinkwitzRileyCrossover<f64>> {
