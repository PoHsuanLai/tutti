...
/// SoundFont synthesizer with per-channel MIDI state, voice allocation, and optional reverb/chorus.
#[derive(Debug, Clone)]
#[non_exhaustive]
...
impl Synthesizer {
    ...
    /// Renders stereo audio into the provided buffers. Both must be the same length.
