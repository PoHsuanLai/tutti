...
| V-2 | `with_*` means both an alternate constructor (51 sites) and a chainable builder (68 sites), sometimes in one `impl` block 100 lines apart. Chainable wins; alternate constructors get real names. | workspace-wide; e.g. `tutti-nodes/src/limiter.rs:183` vs `:290` | open |
